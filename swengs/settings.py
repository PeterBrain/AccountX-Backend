"""
Django settings for swengs project.
...
SECRET_KEY = 'w4tojbofh-g-th%y7btn+zbhy&2)_3x$p1%+qf_cm9+yf55pk('
...
WSGI_APPLICATION = 'swengs.wsgi.application'
